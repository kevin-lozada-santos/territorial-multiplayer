@echo off
setlocal
title Territorial DEVELOPER BUILD
cd /d "%~dp0"
set "GAME_URL=https://kevin-lozada-santos.github.io/territorial-multiplayer/index.html?build=developer"

echo ============================================================
echo Territorial - DEVELOPER BUILD
echo Build: STABLE-LOCALHOST-8000-USER-TEXT-CLEANUP
echo ============================================================
echo.
echo Opening the public HTTPS developer build.
